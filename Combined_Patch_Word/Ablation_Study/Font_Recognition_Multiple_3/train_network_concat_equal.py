...
from network_model import VariousModels, CombineMultiOutputModelConcat
...
def create_save_multi_dataset_together():
    ...
    train_imgs_obj = multiloaderDataset(training_imag_paths_words, training_imag_paths_patch, 600,
    ...
    validation_imgs_obj = multiloaderDataset(validation_imag_paths_words, validation_imag_paths_patch, 150,
    ...
    print("This is a sample of training data")
    print(train_imgs_obj[28])

    print("\n\n\n This is a sample of validation data")
    print(validation_imgs_obj[28])

    return mn_dataset_loader_train, mn_dataset_loader_validation


def main():
    logger = Logger('/home/tmondal/Python_Projects/Font_Recognition/Combined_Patch_Word/Backup/Font_Recognition_Multiple_1/logs/' +

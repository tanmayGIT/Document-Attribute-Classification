...
def create_save_multi_dataset_together():
    ...
    train_imgs_obj = multiloaderDataset(training_imag_paths_words, training_imag_paths_patch, 300,
    ...
    validation_imgs_obj = multiloaderDataset(validation_imag_paths_words, validation_imag_paths_patch, 60,

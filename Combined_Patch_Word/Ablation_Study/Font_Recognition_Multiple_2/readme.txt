...
This is the code where, I can only read two images in the data loader. Hence, I only train by using these two image. But here in this code, I only give patch images at both the times

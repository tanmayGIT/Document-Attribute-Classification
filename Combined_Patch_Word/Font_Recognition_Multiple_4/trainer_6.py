...
class Trainer:
    def __init__(self, model, optimizer, lr_schedule, is_use_cuda, train_data_loader,
        ...
        if train_me_where == "from_middle":
            epoch_num = "52"
            checkpoint = torch.load('/home/tmondal/Python_Projects/Font_Recognition/Combined_Patch_Word/Backup/Font_Recognition_Multiple_4/checkpoint_6/' + model_name + '/Models_epoch_'
                                    + epoch_num + '.ckpt')
    ...
    def _save_best_model(self):
        ...
        if not os.path.isdir('/home/tmondal/Python_Projects/Font_Recognition/Combined_Patch_Word/Backup/Font_Recognition_Multiple_4/checkpoint_6/'
                             + self.model_name):
            os.makedirs('/home/tmondal/Python_Projects/Font_Recognition/Combined_Patch_Word/Backup/Font_Recognition_Multiple_4/checkpoint_6/' +
                        self.model_name)
        ...
        torch.save(state,
                   '/home/tmondal/Python_Projects/Font_Recognition/Combined_Patch_Word/Backup/Font_Recognition_Multiple_4/checkpoint_6/' +

...
from network_model import VariousModels, CombineMultiOutputModelEarlyConcat_3
...
def main():
    ...
    saved_model_path = "/home/tmondal/Python_Projects/Font_Recognition/Combined_Patch_Word/Backup/Font_Recognition_Multiple_4/checkpoint_3/resnet_multi_task/Models_epoch_64.ckpt"
    ...
    dd = .1
    model = CombineMultiOutputModelEarlyConcat_3(model_ft, dd)

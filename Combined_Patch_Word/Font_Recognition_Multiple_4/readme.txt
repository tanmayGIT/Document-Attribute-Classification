...
This is the code where, I can only read two images in the data loader. Hence, I only train by using these two image. Here in this code, I  give patch images and word images together.

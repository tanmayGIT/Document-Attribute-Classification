...
# using "CombineMultiOutputModelConcat_NoBatchNorm" function here and also have increased the batch size and dataset size 
...
from network_model import VariousModels, CombineMultiOutputModel, CombineMultiOutputModelConcat, CombineMultiOutputModelConcat_DropOut
...
def main():
    ...
    dd = .1
    model_1 = CombineMultiOutputModelConcat_DropOut(model_ft, dd)

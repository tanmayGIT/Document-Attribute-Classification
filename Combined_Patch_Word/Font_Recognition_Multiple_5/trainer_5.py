# In this code, I am trying to use AlexNet for word and patch combination
import numpy as np
import torch
...
class Trainer:
    def __init__(self, model, optimizer, lr_schedule, is_use_cuda, train_data_loader,
        ...
        if train_me_where == "from_middle":
            epoch_num = "52"
            checkpoint = torch.load('/home/tmondal/Python_Projects/Font_Recognition/Combined_Patch_Word/Backup/Font_Recognition_Multiple_5/checkpoint_3/' + model_name + '/Models_epoch_'
                                    + epoch_num + '.ckpt')
    ...
    def _save_best_model(self):
        ...
        if not os.path.isdir('/home/tmondal/Python_Projects/Font_Recognition/Combined_Patch_Word/Backup/Font_Recognition_Multiple_5/checkpoint_3/'
                             + self.model_name):
            os.makedirs('/home/tmondal/Python_Projects/Font_Recognition/Combined_Patch_Word/Backup/Font_Recognition_Multiple_5/checkpoint_3/' +
                        self.model_name)
        ...
        torch.save(state,
                   '/home/tmondal/Python_Projects/Font_Recognition/Combined_Patch_Word/Backup/Font_Recognition_Multiple_5/checkpoint_3/' +
                   self.model_name + '/Models' + '_epoch_%d' % self.cur_epoch + '.ckpt')  # Notice

        # torch.save(self.best_model_wts, './checkpoint_best_weights/' + self.model_name + '/Models' +
        # '_epoch_%d' % self.cur_epoch + '.pth')
            ...
            for phase in ['train', 'val']:
                ...
                for inputs_1, inputs_2, single_image_label_scans, single_image_label_sizes, single_image_label_types, \
                    ...
                    with torch.set_grad_enabled(phase == 'train'):
                        ...
                        outputs = self.model(inputs_1, inputs_2)

# In this code, I am trying to use AlexNet for patch and noisy patch combination
...
from trainer_5 import Trainer
from torchvision import transforms
import numpy as np
from multi_image_data_loader_new_ver1 import WordImageDS as multiloaderDataset
from network_model import VariousModels, CombineMultiOutputModelConvAlexNet
...
def main():
    ...
    dd = .1
    model_1 = CombineMultiOutputModelConvAlexNet(model_ft, dd)

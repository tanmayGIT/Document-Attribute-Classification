...
from trainer_weighted_concat import Trainer
from torchvision import transforms
import numpy as np
from multi_image_data_loader_new import WordImageDS as multiloaderDataset
from network_model import VariousModels, CombineMultiOutputModelWeightedConcat1
...
def main():
    ...
    dd = .5
    model_1 = CombineMultiOutputModelWeightedConcat1(model_ft, dd)

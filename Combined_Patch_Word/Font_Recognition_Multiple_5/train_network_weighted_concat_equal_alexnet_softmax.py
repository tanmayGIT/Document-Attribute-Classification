...
from trainer_weighted_concat_alexnet_softmax import Trainer
from torchvision import transforms

from multi_image_data_loader_new import WordImageDS as multiloaderDataset
from network_model import VariousModels, CombineMultiOutputModelWeightedConcatAlexNet_1
...
def main():
    ...
    dd = .5
    model_1 = CombineMultiOutputModelWeightedConcatAlexNet_1(model_ft, dd)

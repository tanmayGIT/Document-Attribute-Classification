# In this code, I am trying to use VggNet for patch and noisy patch combination
...
from trainer_6 import Trainer
from torchvision import transforms
import numpy as np
from multi_image_data_loader_new_ver1 import WordImageDS as multiloaderDataset
from network_model import VariousModels, CombineMultiOutputModelConvVggNetSimple
...
def main():
    logger = Logger('/home/tmondal/Python_Projects/Font_Recognition/Combined_Patch_Word/Backup/Font_Recognition_Multiple_5/logs/' +
    ...
    dd = .1
    model_1 = CombineMultiOutputModelConvVggNetSimple(model_ft)

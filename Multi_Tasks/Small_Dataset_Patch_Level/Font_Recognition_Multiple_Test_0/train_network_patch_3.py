# Here in this code, I am using the convolution idea on word images instead of the linear layer. Here we are using AlexNet
...
from network_model import VariousModels, MultiOutputModelConvAlex
...
def main():
    ...
    dd = .1
    model_1 = MultiOutputModelConvAlex(model_ft, dd)

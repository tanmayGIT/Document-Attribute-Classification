...
def main():
    ...
    saved_model_path = "/home/tmondal/Python_Projects/Font_Recognition/Word_Level/Backup_Data/Font_Recognition_Multiple_Word_Test/checkpoint_3/resnet_multi_task/Models_epoch_76.ckpt"
    ...
    test_imgs_obj = WordImageDS(test_imag_paths, 150, transform=data_transforms['test'])
    ...
    dd = .1
    model = MultiOutputModelConvVggNet(model_ft, dd)

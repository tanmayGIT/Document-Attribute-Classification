...
class MultiOutputModel(nn.Module):
    def __init__(self, model_core, dd):
        ...
        self.x1 = nn.Linear(512, 256)  # first linear
        nn.init.xavier_normal_(self.x1.weight)

        self.x2 = nn.Linear(256, 256)      # second linear
        nn.init.xavier_normal_(self.x2.weight)

        self.bn1 = nn.BatchNorm1d(256, eps=2e-1)    # first batch norm
        self.bn2 = nn.BatchNorm1d(256, eps=2e-1)    # second batch norm

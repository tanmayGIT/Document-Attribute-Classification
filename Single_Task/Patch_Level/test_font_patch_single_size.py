...
def main():
    ...
    network_type = "font_size"  # change here
    ...
    checkpoint = torch.load(saved_model_path_size)  # change here
    ...
    print('Testing Accuracy Font Size : {:4f}'.format(float(variable_acc)))

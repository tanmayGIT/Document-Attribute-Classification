...
def main():
    ...
    network_type = "scanning"  # change here
    ...
    checkpoint = torch.load(saved_model_path_scan)  # change here
    ...
    print('Testing Accuracy Scanning Resolution : {:4f}'.format(float(variable_acc)))

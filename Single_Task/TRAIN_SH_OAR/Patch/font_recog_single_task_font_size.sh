...
python -u /home/tmondal/Python_Projects/Patch_Level/Font_Recognition_Single/train_network_word_level_SingleModel.py --resume "janinah" --model "resnet" --taskname "font_size" --batch_size 500 --number_of_class 3 --epoch_num_to_load "2"

...
python -u /home/tmondal/Python_Projects/Font_Recognition_Single/train_network_word_level_SingleModel.py --resume "janinah" --model "resnet" --taskname "font_emphasis" --batch_size 800 --number_of_class 4

...
from SingleNetworkTrainer import SingleNetworkTrainer
...
def main(args):
    ...
    # gpu_tracker.track()
    # Train and evaluate
    my_trainer = SingleNetworkTrainer(model_1, optimizer_ft, exp_lr_scheduler, is_use_cuda, mn_dataset_loader_train,
                                      mn_dataset_loader_valid, start_epoch, num_epochs, logger, model_name, task_name)
    my_trainer.train()
